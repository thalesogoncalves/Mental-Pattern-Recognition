function [Signals] = fcn(File,Electrodes,TestNumber)
...
data = load(cat(2,'C:\Users\thalesogoncalves\Google Drive\Engenharia\TCC\Matlab\Base de Dados\',num2str(TestNumber),'\',File));
for i = 1 : ElecQtdd
