function [Signals] = fcn(Electrodes,TestNumber)
...
data = load(cat(2,'C:\Users\thalesogoncalves\Google Drive\Engenharia\TCC\Matlab\Sincr\Base de Dados\',num2str(TestNumber),'.ASC'));
for i = 1 : ElecQtdd
